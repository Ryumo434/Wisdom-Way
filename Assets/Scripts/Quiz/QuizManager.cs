...
public class QuizManagerTMP : MonoBehaviour
{
    ...
    {
        {"Wer war der erste Pr‰sident der USA?", "George Washington", "Abraham Lincoln", "Thomas Jefferson", "John Adams"},
        {"Wann begann der Zweite Weltkrieg?", "1937", "1939", "1941", "1945"},
        {"Wann endete der Zweite Weltkrieg?", "1943", "1944", "1945", "1946"},
        {"In welchem Jahr wurde die Berliner Mauer gebaut?", "1948", "1950", "1961", "1989"},
        {"Wer war Julius Caesar?", "Rˆmischer Kaiser", "Griechischer Philosoph", "ƒgyptischer Pharao", "Indischer Kˆnig"}
    };
    ...
    private string[,] scienceQuizData = new string[,]
    {
        ...
        {"Was ist das grˆﬂte Organ des menschlichen Kˆrpers?", "Herz", "Leber", "Lunge", "Haut"},
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.CompareTag("Player"))
        {
            ...
            // ‹berpr¸fen, welcher Trigger das Quiz auslˆst
    ...
    public void SelectAnswer(int answerIndex)
    {
        ...
        {
            Debug.LogError("currentQuestionIndex ist auﬂerhalb des Bereichs!");
            return;
        }

        Debug.Log("Ausgew‰hlte Antwort: " + quizData[currentQuestionIndex, answerIndex + 1]);
